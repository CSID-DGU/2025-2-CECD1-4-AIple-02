...
class Scratch: 
  def __init__(self, f_saved): 
    ...
    if check_if_file_exists(f_saved): 
      ...
      #종합설계 1 수정
      self.mbti_axis = scratch_load["mbti_axis"] if "mbti_axis" in scratch_load else None
  ...
  def save(self, out_json):
    ...
    #종합설계1 수정
    scratch["mbti_axis"] = self.mbti_axis
  ...
  #종합설계1 수정
  def get_str_mbti(self):
    return self.mbti_axis or ""
